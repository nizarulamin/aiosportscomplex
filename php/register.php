...
<body>
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button">
        <div class="container"><a class="navbar-brand" href="index.html" style="color: rgb(5,90,218);" data-bs-target="index.html">AIO Sports Complex</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                </ul><span class="navbar-text actions"> <a class="login" href="login.html">Log In</a><a class="btn btn-light action-button" role="button" href="register.html" style="background: rgb(5,90,218);">Sign Up</a></span>
            </div>
        </div>
    </nav>
    <section class="register-photo" style="background: #ffffff;margin-top: 31px;">
        <div class="form-container" style="max-height: 450px;">
            ...
            <form method="post" action = "POST" style="height: 456px;">
                <h2 class="text-center"><strong>Create</strong> an account.</h2>
                <div class="mb-3"><input class="form-control" type="text" name="username" placeholder="Username"></div>
                <div class="mb-3"><input class="form-control" type="email" name="email" placeholder="Email"></div>
                <div class="mb-3"><input class="form-control" type="telnum" name="telnum" placeholder="Phone Number"></div>
                ...
                <div class="mb-3"><button class="btn btn-primary d-block w-100" type="submit" style="background: rgb(1,174,230);">Sign Up</button></div><a class="already">Already have an account?</a><a class="already" href="login.html"><b>Login here.</b></a>
            </form>
        </div>
    </section>
