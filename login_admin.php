    ...
    <nav class="navbar navbar-light navbar-expand-md navigation-clean-button">
        <div class="container"><a class="navbar-brand" href="index.php" style="color: rgb(5,90,218);" data-bs-target="index.php">AIO Sports Complex</a><button data-bs-toggle="collapse" class="navbar-toggler" data-bs-target="#navcol-1"><span class="visually-hidden">Toggle navigation</span><span class="navbar-toggler-icon"></span></button>
            <div class="collapse navbar-collapse" id="navcol-1">
                ...
                </ul><span class="navbar-text actions"> <a class="login"  href="login_admin.php">Log In</a><a class="btn btn-light action-button" role="button" href="register.php" style="background: rgb(5,90,218);">Sign Up</a></span>
            </div>
        </div>
    </nav>
    <section class="highlight-clean" style="background: rgba(255,255,255,0.4);">
        <section class="login-clean">
            <form action="login.php" method="POST">
                ...
                <div class="mb-3"><button class="btn btn-primary d-block w-100" name="submit" type="submit" style="background: #12b5e8;">Log In</button></div><a class="forgot" href="register.php">No account? Create here.</a><a class="forgot" href="login.php"><h6><b>Customer login<b></h6></a>
            </form>
        </section>
    </section>
